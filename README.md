...
Training and test datasets for the 2d (one antenna) and the 6d (3 antennas) cases are in the R workspaces : antennes_2d_test.Rdata,antennes_2d_train.Rdata, antennes_6d_test.Rdata, antennes_2d_train.Rdata (MATLAB workspaces are in the folder /SVR/SVR/ with the same names)
